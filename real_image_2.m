...
boundary1=BB{1}(300:500,:)';
% plot(boundary1(60:250,2),boundary1(60:250,1),'r-');
plot(boundary1(2,:),boundary1(1,:),'b-','LineWidth',3);
% 
boundary2=BB{8}(1:80,:)';
% plot(boundary1(60:250,2),boundary1(60:250,1),'r-');
plot(boundary2(2,:),boundary2(1,:),'b-','LineWidth',3);
% 
% % % %利用两条直线进行畸变系数矫正
...
hold on;
plot(XY_u1(1,:),XY_u1(2,:),'g-','LineWidth',3);
plot(XY_u2(1,:),XY_u2(2,:),'g-','LineWidth',3);